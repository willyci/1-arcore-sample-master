...
namespace HelloAR
{
    ...
    public class MainActivity : AppCompatActivity, GLSurfaceView.IRenderer, Android.Views.View.IOnTouchListener
    {
        ...
        public void OnDrawFrame(IGL10 gl)
        {
            ...
            try
            {
                ...
                if (tap != null && camera.TrackingState == TrackingState.Tracking)
                {
                    ...
                    showLoadingObjMessage("4. you tap me " + mAnchors.Count.ToString() + " times.");
                }
                ...
                showLoadingObjMessage("5. start draw andy " + mAnchors.Count.ToString() + " times.");
                ...
                foreach (var anchor in mAnchors)
                {
                    ...
                    if (count % 2 == 0) {   
                         ...
                         showLoadingObjMessage("6.3. draw andy");
                    }
                    else {
                        mVirtualObjectShadow.updateModelMatrix(mAnchorMatrix, scaleFactor);
                        mVirtualObjectShadow.Draw(viewmtx, projmtx, lightIntensity);
                        showLoadingObjMessage("6.5. draw shadow");
                    }
                    count++;
                }
            ...
            catch (System.Exception ex)
            {
                ...
                showLoadingObjMessage("7. " + mAnchors.Count.ToString() +" - "+ ex);
            }
        }
        ...
        // show load obj
        private void showLoadingObjMessage(string msg)
        {
            this.RunOnUiThread(() =>
            {
                mLoadingMessageSnackbar = Snackbar.Make(FindViewById(Android.Resource.Id.Content),
                    msg, Snackbar.LengthIndefinite);
                mLoadingMessageSnackbar.View.SetBackgroundColor(Android.Graphics.Color.DarkGray);
                mLoadingMessageSnackbar.Show();
            });
        }
